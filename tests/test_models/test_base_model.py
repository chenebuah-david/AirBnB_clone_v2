...
class test_basemodel(unittest.TestCase):
    """ This test class for base_model class"""

    def __init__(self, *args, **kwargs):
        """ This init the test class of basemodel"""
    ...
    def tearDown(self):
        """This is the teardown method of the ctest class"""
        try:
            os.remove('file.json')
        except Exception:
            pass
    ...
    def test_init(self):
        """This tests the initialization of the model class.
        """
    ...
    def test_default(self):
        """ The default testing of basemodel"""
        i = self.value()
        self.assertEqual(type(i), self.value)

    def test_kwargs(self):
        """ The testing basemodel with kwargs"""
        i = self.value()
        copy = i.to_dict()
        new = BaseModel(**copy)
    ...
    def test_kwargs_int(self):
        """ The testing with kwargs again but with int kwargs"""
        i = self.value()
        copy = i.to_dict()
        copy.update({1: 2})
    ...
    def test_str(self):
        """ The testing of the str method of themodel"""
        i = self.value()
        self.assertEqual(str(i), '[{}] ({}) {}'.format(self.name, i.id,
                         i.__dict__))

    def test_todict(self):
        """ The testing of the to_dict method"""
        i = self.value()
        n = i.to_dict()
        self.assertEqual(i.to_dict(), n)
        # This tests if it's a dictionary
        self.assertIsInstance(self.value().to_dict(), dict)
        # This tests if to_dict contains accurate keys
        ...
        # This tests if to_dict contains added attributes
        mdl = self.value()
        ...
        # This tests to_dict output contradiction
        mdl_d = self.value()
    ...
    def test_kwargs_none(self):
        """ The testing kwargs again with none"""
        n = {None: None}
        with self.assertRaises(TypeError):
            new = self.value(**n)

    def test_kwargs_one(self):
        """ The testing kwargs with one arg"""
        n = {'name': 'test'}
        new = self.value(**n)
        self.assertEqual(new.name, n['name'])

    def test_id(self):
        """ The testing id attr of the model"""
        new = self.value()
        self.assertEqual(type(new.id), str)

    def test_created_at(self):
        """ The testing created at attr"""
        new = self.value()
        self.assertEqual(type(new.created_at), datetime)

    def test_updated_at(self):
        """ The testing updated at attr"""
        new = self.value()
