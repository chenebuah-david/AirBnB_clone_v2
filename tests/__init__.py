#!/usr/bin/python3
"""This tests for the AirBnb clone modules
"""
import os
...
def clear_stream(stream: TextIO):
    """This will clear the contents of a given stream
...
def delete_file(file_path: str):
    """This will remove a file if it exists
    Args:
...
def reset_store(store: FileStorage, file_path='file.json'):
    """Resets Items in the given store
    Args:
...
def write_text_file(file_name, text):
    """This writes a text to a given file
