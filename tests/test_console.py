#!/usr/bin/python3
"""This is a unit test module for the console (command interpreter)
"""
import json
import MySQLdb
import os
...
class TestHBNBCommand(unittest.TestCase):
    """This represents the test class for the HBNBCommand class
    """
    @unittest.skipIf(
        os.getenv('HBNB_TYPE_STORAGE') == 'db', 'FileStorage test')
    def test_fs_create(self):
        """This tests the create command with the file storage
        """
    ...
    def test_db_create(self):
        """This tests the create command with the database storage
        """
        with patch('sys.stdout', new=StringIO()) as cout:
            cons = HBNBCommand()
            # creates a model with non-null attribute(s)
    ...
    def test_db_show(self):
        """This tests the show command with the database storage
        """
        with patch('sys.stdout', new=StringIO()) as cout:
            cons = HBNBCommand()
    ...
    def test_db_count(self):
        """This tests the count command with the database storage
        """
        with patch('sys.stdout', new=StringIO()) as cout:
            cons = HBNBCommand()
            dbc = MySQLdb.connect(
